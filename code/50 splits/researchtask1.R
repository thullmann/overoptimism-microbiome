...
assoc_distbased = read_excel("code/optimization functions/assoc_methods.xlsx", sheet = "distbased")
assoc_networkbased = read_excel("code/optimization functions/assoc_methods.xlsx", sheet = "networkbased")
...
for (n in c(100, 250, 500, 1000, 4000)) {
  ...
  saveRDS(clust_results, paste0("results/clustering genera/clust_results_", n, ".rds"))
